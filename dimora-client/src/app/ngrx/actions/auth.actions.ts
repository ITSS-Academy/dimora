...
export const storeCurrentUser = createAction(
  '[Auth] Store Current User', props<{mineProfile: AuthModel}>()
)

export const storeIdToken = createAction(
  '[Auth] Store Id Token', props<{idToken: string}>()
)


export const getUserByGoogleId = createAction(
  '[Auth] Get User By Google Id', props<{googleId: string, idToken: string}>()
)

export const getUserByGoogleIdSuccess = createAction(
  '[Auth] Get User By Google Id Success', props<{mineProfile: AuthModel}>()
)

export const getUserByGoogleIdFailure = createAction(
  '[Auth] Get User By Google Id Failure', props<{error: any}>()
);


//get usser by id
export const getUserById = createAction(
  '[Auth] Get User By Id', props<{id: string}>()
)

export const getUserByIdSuccess = createAction(
  '[Auth] Get User By Id Success', props<{currentUser: AuthModel}>()
)

export const getUserByIdFailure = createAction(
  '[Auth] Get User By Id Failure', props<{error: any}>()
);
